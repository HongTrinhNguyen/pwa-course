...
export default class CustomeReporter implements Reporter {
    ...
    async onEnd(result: FullResult): Promise<void | { status?: FullResult["status"] } | undefined> {
        ...
        console.log("🚀 ~ CustomeReporter ~ onEnd ~ chatIdTele:", chatIdTele)
        console.log("🚀 ~ CustomeReporter ~ onEnd ~ webhookTele:", webhookTele)
        console.log("🚀 ~ CustomeReporter ~ onEnd ~ webhookSlack:", webhookSlack)
        console.log("🚀 ~ CustomeReporter ~ onEnd ~ webhookDiscord:", webhookDiscord)
       ...
       const bodySlack = {
        ...
        const responseTelegram = await fetch(webhookTele, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            },
