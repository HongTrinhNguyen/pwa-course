...
test.describe("PRODUCT_001 - Tạo product thành công tren dev", async () => {
...
test.describe("PRODUCT_001 - Tạo product thành công tren prod", async ()=> {
    test.describe("PRODUCT_001", async () => {
